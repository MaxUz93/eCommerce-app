...
const Sort = () => {
  const { filter_products, grid_view, setGridView, setListView, sort, sortUpdate } = useFilterContext()
  ...
  return (
    <Wrapper>
      ...
      <form>
        ...
        <select name="sort" id="sort" className='sort-input' value={sort} onChange={sortUpdate}>
